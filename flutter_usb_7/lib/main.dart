...
class _MyAppState extends State<MyApp> {
  ...
  _sendMessageButtonPressed([String message = "a"]) async {
    bool isMessageSent = await _flutterSerialCommunicationPlugin.write(Uint8List.fromList(message.codeUnits));
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  FilledButton(
                    onPressed: isConnected ? () => _sendMessageButtonPressed("1") : null,
                    child: const Icon(Icons.flash_on),
                  ),
                  FilledButton(
                    onPressed: isConnected ? () => _sendMessageButtonPressed("0") : null,
