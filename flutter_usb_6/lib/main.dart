...
class _MyAppState extends State<MyApp> {
  ...
  _sendMessageButtonPressed({String message = '1'}) async {
    String formattedMessage = message + '\r\n';
    bool isMessageSent = await _flutterSerialCommunicationPlugin
        .write(Uint8List.fromList(formattedMessage.codeUnits));
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  ElevatedButton(onPressed: isConnected ? () => _sendMessageButtonPressed(message: "1") : null, child: const Icon(Icons.flash_on)),
                  ElevatedButton(onPressed: isConnected ? () => _sendMessageButtonPressed(message: "0") : null, child: const Icon(Icons.flash_off)),
                ],
              )
            ],
          ),
